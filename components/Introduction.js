...
const Introduction = (props) => {
  return (
    <div className="h-full sm:h-1/2 bg-secondary pb-48 text-white font-lora flex flex-col items-center " style={{ clipPath: 'ellipse(80% 70% at 50% 30%)' }}>
      <div className="pt-20">
        <img className='mx-auto h-16 w-16' src='dan.png' />
        <h3 className='pt-6 text-center font-semibold text-4xl'>About me</h3>
        <p className='w-10/12 lg:w-6/12 mx-auto text-center tracking-tight pt-6 text-lg font-lora'>
